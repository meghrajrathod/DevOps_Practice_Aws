# AWS-CLI VPC Project – Working Explanation

This project demonstrates how a complete AWS infrastructure works together using AWS-CLI. It creates a custom Virtual Private Cloud (VPC) with both public and private networking layers, allowing secure and controlled access to resources.
